...
use App\Shop\Products\Certificates\Certificate;
...
class ProductRepository extends BaseRepository implements ProductRepositoryInterface
{
    ...
    /**
     * Create or update the certificate attached to the product.
     *
     * @param array $data
     * @return Certificate
     */
    public function saveCertificate(array $data) : Certificate
    {
        return $this->model->certificate()->updateOrCreate(
            ['product_id' => $this->model->id],
            $data
        );
    }
