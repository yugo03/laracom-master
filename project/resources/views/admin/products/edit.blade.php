                            ...
                            <div class="tab-content" id="tabcontent">
                                ...
                                <div role="tabpanel" class="tab-pane" id="certificate">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <p class="text-muted">
                                                This certificate is only shown to the customer who purchased this
                                                product, on their purchase history page.
                                            </p>
                                            <div class="form-group">
                                                <label for="appraiser_name">Appraiser name</label>
                                                <input type="text" name="appraiser_name" id="appraiser_name" class="form-control" value="{{ optional($certificate)->appraiser_name }}">
                                            </div>
                                            <div class="form-group">
                                                <label for="grade">Grade</label>
                                                <input type="text" name="grade" id="grade" class="form-control" value="{{ optional($certificate)->grade }}">
                                            </div>
                                            <div class="form-group">
                                                <label for="serial_number">Serial number</label>
                                                <input type="text" name="serial_number" id="serial_number" class="form-control" value="{{ optional($certificate)->serial_number }}">
                                            </div>
                                            <div class="form-group">
                                                <label for="appraised_at">Appraised at</label>
                                                <input type="date" name="appraised_at" id="appraised_at" class="form-control" value="{{ optional($certificate)->appraised_at ? $certificate->appraised_at->format('Y-m-d') : '' }}">
                                            </div>
                                            <div class="form-group">
                                                <label for="certificate_notes">Notes</label>
                                                <textarea name="certificate_notes" id="certificate_notes" rows="4" class="form-control">{{ optional($certificate)->notes }}</textarea>
                                            </div>
                                            @if($certificate && $certificate->file)
                                                <div class="form-group">
                                                    <label>Current file</label><br>
                                                    <a href="{{ asset("storage/{$certificate->file}") }}" target="_blank">View current certificate file</a>
                                                </div>
                                            @endif
                                            <div class="form-group">
